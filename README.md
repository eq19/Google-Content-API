# Google Content API
:hand: Selamat datang di [Halaman Project](https://github.com/MarketLeader) untuk sesi [**Google Content API**](https://github.com/MarketLeader/Google-Content-API).

Sesi ini adalah sesi kedua publikasi [**Tim Chetabahana**](https://github.com/chetabahana) dari sesi utama yaitu: [_Toko-Chetabahana_](https://github.com/MarketLeader/Toko-Chetabahana) kelanjutan sesi pertama yaitu [ Google-Sites-API ](https://github.com/MarketLeader/Google-Sites-API) sebelum menginjak sesi ketiga yaitu [ Google-AdWords-API ](https://github.com/MarketLeader/Google-AdWords-API).
